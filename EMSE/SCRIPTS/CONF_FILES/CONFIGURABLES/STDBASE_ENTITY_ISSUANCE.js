...
function generateLicenseApplications(capIdObject, jsonRules) {
	...
	var customFieldGroup = jsonRules.criteria.customFieldGroup;
	var customFieldRecordGrouping = jsonRules.criteria.customFieldRecordGrouping
	var customListName = jsonRules.criteria.customListName;
